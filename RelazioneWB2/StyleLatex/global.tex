...
\end{center}
  ...
  \begin{tabular}{l|l}
  	...
  	\textbf{Dati login utente} & username: user@user.it \\
  	& password: user \\
  	\textbf{Dati login admin} & username: admin@admin.it \\
  	& password: admin \\
  	\textbf{Dati login azienda} & username: azienda@azienda.it \\
  	& password: azienda \\
  	\textbf{Username consegna} & mcanoves\\ 
  	\hline
  \end{tabular}
...
\begin{center}
	...
	http://tecweb2016.studenti.math.unipd.it/mcanoves/}????
\end{center}
